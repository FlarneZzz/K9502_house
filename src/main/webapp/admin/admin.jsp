...
<div region="north" split="true" border="false" style="overflow: hidden; height: 30px;
    ...
    <span style="float:right; padding-right:20px;" class="head">欢迎 某某 <a href="#" id="editpass" style="color:#fff;">修改密码</a>
        <a href="#" id="loginOut" style="color:#fff;">安全退出</a></span>
    <span style="padding-left:10px; font-size: 16px; ">
        <img src="images/blocks.gif" width="20" height="20" align="absmiddle"/>XX后台管理系统</span>
</div>

<div region="south" split="true" style="height: 30px; background: #D2E0F2; ">
    <div class="footer">后台管理系统 版权归王建兵所有 联系方式:13260601227</div>
</div>
...
<script type="text/javascript">
    var _menus = {"menus":[
            {"menuid":"1","icon":"icon-sys","menuname":"区域管理",
                ...
                "menus":[{"menuid":"21","menuname":"用户列表","icon":"icon-nav","url":"users.jsp"},
                    {"menuid":"22","menuname":"视频监控","icon":"icon-nav","url":"demo1.html"}
                ]
            },{"menuid":"56","icon":"icon-sys","menuname":"房屋审核",
                "menus":[{"menuid":"31","menuname":"未审核","icon":"icon-nav","url":"waitingForCheckingHouse.jsp"},
                    {"menuid":"32","menuname":"已审核","icon":"icon-nav","url":"havingCheckingHouse.jsp"}
                ]
            },{"menuid":"28","icon":"icon-sys","menuname":"类型管理",
                "menus":[{"menuid":"41","menuname":"房屋类型","icon":"icon-nav","url":"housetype.jsp"},
                ]
