...
<%-------------------------------------------------------------------------------------------------%>
<%-------------------------------------街道对话框--------------------------------------%>
<div id="street_option" class="easyui-dialog" buttons="#addStreetButtons"
    ...
    <form id="addStreetForm" method="post">
        <table>
            <tr>
                <td>街道区域编号:</td>
                <td><input type="text" readonly  style="border: none" class="easyui-validatebox" required
                           name="districtId" id="district_id"/></td>

            </tr>
            <tr>
                <td>街道名称:</td>
                <td><input type="text" class="easyui-validatebox" required
                           name="name" id="streetname"/></td>
                <td><a href="javascript:addStreet()"
                       class="easyui-linkbutton" iconCls="icon-add">添加</a></td>
            </tr>
        </table>
    </form>
</div>
<%-------------------------------------------------------------------------------------------------%>
<%-------------------------------------街道对话框按钮--------------------------------------%>
<div id="addStreetButtons">
    <a href="javascript:closedialog('street_option')"
       class="easyui-linkbutton" iconCls="icon-cancel">取消</a>
</div>
<%-------------------------------------------------------------------------------------------------%>
<!-----------------------------定义修改对话框中的按钮------------------------------------------>
